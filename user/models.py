...
from core.utils.jira_utils import get_all_jira_users
...
class User(AbstractBaseUser, PermissionsMixin):
    JIRA_USER_CHOICE = [(item.key, item.displayName) for item in get_all_jira_users()]

    username = models.EmailField(verbose_name=_('email'), max_length=100, unique=True)
    ...
    jira_user_key = models.CharField(verbose_name=_('jira user'), max_length=100, choices=JIRA_USER_CHOICE, null=True,
                                     blank=True)
